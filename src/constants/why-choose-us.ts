export const WHY_CHOOSE_US = [
  ...
  },
  {
    ...
    title: "Peace of Mind ",
    content:
      "LoomFare is fully licensed and regulated so you can venture into the world of cryptocurrencies safely.",
  },
  {
  ...
  },
  {
    ...
    content:
      "LoomFare utilizes advanced tools that help us protect users and identify, prevent, and insure against losses from fraud.",
  },
  {
    img: { url: "/why-chose-us/support2.svg", alt: "Support" },
    title: "24/7 Support",
    content:
      "We all need a helping hand from time to time. At LoomFare,  our exceptional customer care team is available to assist you around the clock.",
  },
];
